...
export const triggerRecurringTransactions = inngest.createFunction(
    ...
    { cron: "0 0 * * *" },
    async ({ step }) => {
        // First Fetch all due recurring transactions
        ...
        //Secondly Create events for each transaction
        if( recurringTransactions.length > 0) {
            ...
            // Third Send events to be processed
...
async function generateFinancialInsights(stats, month) {
        ...
        try {
            ...
            return [
                ...
                "Consider setting a budget for categories where you spent the most.",
